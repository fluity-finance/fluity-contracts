...
class DeploymentHelper {
  ...
  static async deployTesterContractsHardhat() {
    ...
    await testerContracts.lusdToken.unpause()
  ...
  static async connectUnipool(uniPool, LQTYContracts, uniswapPairAddr, duration) {
    await uniPool.setParams(LQTYContracts.lqtyToken.address, uniswapPairAddr, LQTYContracts.lqtyStaking.address, duration)
  }
}
