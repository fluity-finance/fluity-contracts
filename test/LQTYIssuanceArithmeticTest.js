...
// Helper method after changing total issuance
const scaleIssuance = i => th.toBN(i).div(th.toBN('32')).mul(th.toBN('35')).toString()
...
contract('LQTY community issuance arithmetic tests', async accounts => {
  ...
  it("Total LQTY tokens issued is 42.20 after a minute", async () => {
    ...
    const expectedTotalLQTYIssued = scaleIssuance('42200713760820460000')
  ...
  it("Total LQTY tokens issued is 2,531.94 after an hour", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('2531944322115010000000')
  ...
  it("Total LQTY tokens issued is 60,711.40 after a day", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('60711403150133240000000')
  ...
  it("Total LQTY tokens issued is 422,568.60 after a week", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('422568600980110200000000')
  ...
  it("Total LQTY tokens issued is 1,772,113.21 after a month", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('1772113218814930000000000')
  ...
  it("Total LQTY tokens issued is 5,027,363.22 after 3 months", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('5027363224065180000000000')
  ...
  it("Total LQTY tokens issued is 9,264,902.04 after 6 months", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('9264902042296516000000000')
  ...
  it("Total LQTY tokens issued is 16,000,000 after a year", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('16000000000000000000000000')
  ...
  it("Total LQTY tokens issued is 24,000,000 after 2 years", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('24000000000000000000000000')
  ...
  it("Total LQTY tokens issued is 28,000,000 after 3 years", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('28000000000000000000000000')
  ...
  it("Total LQTY tokens issued is 30,000,000 after 4 years", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('30000000000000000000000000')
  ...
  it("Total LQTY tokens issued is 31,968,750 after 10 years", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('31968750000000000000000000')
  ...
  it("Total LQTY tokens issued is 31,999,969.48 after 20 years", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('31999969482421880000000000')
  ...
  it("Total LQTY tokens issued is 31,999,999.97 after 30 years", async () => {
    ...
    await communityIssuanceTester.unprotectedIssueLQTY()
    const totalLQTYIssued = await communityIssuanceTester.totalLQTYIssued()
    const expectedTotalLQTYIssued = scaleIssuance('31999999970197680000000000')
