...
contract('StabilityPool', async accounts => {
  ...
  describe("Stability Pool Mechanisms", async () => {
    ...
    it("provideToSP(), new deposit after past full withdrawal: depositor does not receive any LQTY rewards", async () => {
      ...
      const A_LQTYBalance_Before = await calculateWithdrawableLQTYRewards(A)
      const B_LQTYBalance_Before = await calculateWithdrawableLQTYRewards(B)
      ...
      const A_LQTYBalance_After = await calculateWithdrawableLQTYRewards(A)
      const B_LQTYBalance_After = await calculateWithdrawableLQTYRewards(B)
    ...
    it("provideToSP(), new eligible deposit: tagged front end receives LQTY rewards", async () => {
      ...
      const frontEnd_1_LQTYBalance_After = await calculateWithdrawableLQTYRewards(frontEnd_1)
      const frontEnd_2_LQTYBalance_After = await calculateWithdrawableLQTYRewards(frontEnd_2)
      const frontEnd_3_LQTYBalance_After = await calculateWithdrawableLQTYRewards(frontEnd_3)
    ...
    it("provideToSP(), topup: depositor receives LQTY rewards", async () => {
      ...
      const A_LQTYBalance_Before = await calculateWithdrawableLQTYRewards(A)
      const B_LQTYBalance_Before = await calculateWithdrawableLQTYRewards(B)
      const C_LQTYBalance_Before = await calculateWithdrawableLQTYRewards(C)
      ...
      const A_LQTYBalance_After = await calculateWithdrawableLQTYRewards(A)
      const B_LQTYBalance_After = await calculateWithdrawableLQTYRewards(B)
      const C_LQTYBalance_After = await calculateWithdrawableLQTYRewards(C)
    ...
    it("provideToSP(), topup: tagged front end receives LQTY rewards", async () => {
      ...
      const F1_LQTYBalance_Before = await calculateWithdrawableLQTYRewards(frontEnd_1)
      const F2_LQTYBalance_Before = await calculateWithdrawableLQTYRewards(frontEnd_2)
      const F3_LQTYBalance_Before = await calculateWithdrawableLQTYRewards(frontEnd_3)
      ...
      const F1_LQTYBalance_After = await calculateWithdrawableLQTYRewards(A)
      const F2_LQTYBalance_After = await calculateWithdrawableLQTYRewards(B)
      const F3_LQTYBalance_After = await calculateWithdrawableLQTYRewards(C)
    ...
    it("withdrawFromSP(): succeeds when amount is 0 and system has an undercollateralized trove", async () => {
      ...
      const A_LQTYBalBefore = await calculateWithdrawableLQTYRewards(A)
      ...
      const A_LQTYBalAfter = await calculateWithdrawableLQTYRewards(A)
    ...
    it("withdrawETHGainToTrove(), eligible deposit: tagged front end receives LQTY rewards", async () => {
     ...
     await priceFeed.setPrice(dec(105, 18))
      ...
      // Get front ends' LQTY balance after
      const F1_LQTYBalance_After = await calculateWithdrawableLQTYRewards(frontEnd_1)
      const F2_LQTYBalance_After = await calculateWithdrawableLQTYRewards(frontEnd_2)
      const F3_LQTYBalance_After = await calculateWithdrawableLQTYRewards(frontEnd_3)
