...
contract('Unipool', function ([_, wallet1, wallet2, wallet3, wallet4, bountyAddress, owner]) {
  ...
  describe('Unipool', async function () {
    beforeEach(async function () {
      await deploy(this);
      await this.pool.setParams(this.lqty.address, this.uni.address, this.lqtyStaking.address, this.DURATION);
    });
